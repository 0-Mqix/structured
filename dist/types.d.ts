...
export declare function array<const T extends StructuredType<any> | Structured<any> | readonly Property[]>(size: number, type: T, omitEmptyOnRead?: boolean): StructuredType<InferOutputType<T>[]>;
